...
class AmazonSpider():
        ...
        while True:
            ...
            for result in results:
                try:
                    ...
                    row = (subject,comment,star_comment,time_comment,type_comment)
    ...
    def launch(self, proxyIP = "", ProxyPort = "", continueTask='False'):
        ...
        createtable = 'id int(11) NOT NULL AUTO_INCREMENT,title VARCHAR(200),firstcomment VARCHAR(20000),star VARCHAR(50),date VARCHAR(20),referenceName VARCHAR(200), PRIMARY KEY(id)'
